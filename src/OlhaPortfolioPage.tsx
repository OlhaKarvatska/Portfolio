...
const PORTFOLIO_IMAGES: { src: string; alt: string }[] = [
  ...
  { src: asset('portfolio/content photo examples/7.JPG'), alt: 'Portfolio' },
  { src: asset('portfolio/content photo examples/17.JPG'), alt: 'Portfolio' },
  { src: asset('portfolio/content photo examples/31.JPG'), alt: 'Portfolio' },
  { src: asset('portfolio/content photo examples/46.JPG'), alt: 'Portfolio' },
  { src: asset('portfolio/content photo examples/47.jpg'), alt: 'Portfolio' },
  { src: asset('portfolio/content photo examples/Chez%20Mia%20_%20Interior%20shoot-073.jpg'), alt: 'Portfolio' },
  { src: asset('portfolio/content photo examples/Chez%20Mia-055.jpg'), alt: 'Portfolio' },
  { src: asset('portfolio/content photo examples/CHEZMIA_9-20-25_FOUREYED_D_-85.jpg'), alt: 'Portfolio' },
  { src: asset('portfolio/content photo examples/21.png'), alt: 'Portfolio' },
  { src: asset('portfolio/content photo examples/22.png'), alt: 'Portfolio' },
  { src: asset('portfolio/content photo examples/23.png'), alt: 'Portfolio' },
  { src: asset('portfolio/content photo examples/24.png'), alt: 'Portfolio' },
  { src: asset('portfolio/content photo examples/25.png'), alt: 'Portfolio' },
  { src: asset('portfolio/content photo examples/Tezza-2728.jpg'), alt: 'Portfolio' },
  { src: asset('portfolio/content photo examples/Tezza-3250.JPG'), alt: 'Portfolio' },
  { src: asset('portfolio/content photo examples/Tezza-3885.JPG'), alt: 'Portfolio' },
  { src: asset('portfolio/content photo examples/Tezza-7951.JPG'), alt: 'Portfolio' },
  { src: asset('portfolio/content photo examples/Tezza-9940.jpg'), alt: 'Portfolio' },  
];
...
const CLIENT_HIGHLIGHT_IMAGES: { src: string; alt: string }[] = [
  { src: asset('portfolio/Companies%20i%20worked%20with/Untitled%20design-2.png'), alt: 'Client Logo' },
  { src: asset('portfolio/Companies%20i%20worked%20with/Official%20Logo.png'), alt: 'Client Logo' },
  { src: asset('portfolio/Companies%20i%20worked%20with/IMG_1041-removebg-preview.png'), alt: 'Client Logo' },
  { src: asset('portfolio/Companies%20i%20worked%20with/IMG_0392-removebg-preview.png'), alt: 'Client Logo' },
  { src: asset('portfolio/Companies%20i%20worked%20with/Group%204.PNG'), alt: 'Client Logo' },
  { src: asset('portfolio/Companies%20i%20worked%20with/ChezMia_Wordmark_Blue.png'), alt: 'Chez Mia Wordmark' },
  { src: asset('portfolio/Companies%20i%20worked%20with/BBN_BF_LOGO_30x30.png'), alt: 'BBN Logo' },
];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
              ...
              <div className="flex flex-col justify-between h-full gap-3 md:gap-4 w-full max-w-sm mx-auto">
                 ...
                 <div className="rounded-2xl overflow-hidden relative" style={{ backgroundColor: 'transparent' }}>
                   <div className="absolute inset-0" style={{ backgroundImage: `url(${asset('portfolio/Vitalik/AboutBG_Pink.jpg')})`, backgroundSize: 'cover', backgroundPosition: 'center', mixBlendMode: 'multiply' }}></div>
                 ...
                 {/* Блок 2 */}
                 <div className="rounded-2xl overflow-hidden relative" style={{ backgroundColor: 'transparent' }}>
                   <div className="absolute inset-0" style={{ backgroundImage: `url(${asset('portfolio/Vitalik/AboutBG_White.png')})`, backgroundSize: 'cover', backgroundPosition: 'center', mixBlendMode: 'multiply' }}></div>
                   <div className="p-4 md:p-6 text-center relative z-10">
...
function Services() {
  ...
  return (
    <section id="services" className="relative overflow-hidden">
      <div className="absolute inset-0 opacity-20" style={{ backgroundImage: `url(${asset('portfolio/Vitalik/AboutBG_Pink.jpg')})`, backgroundSize: 'cover', backgroundPosition: 'center' }}></div>
...
function PhotoVideoExamples() {
  ...
  const examples = [
    ...
    { type: 'video', src: asset('portfolio/Vitalik/2025.09.27 influ video .MP4'), alt: 'Influencer Video' },
    ...
    { type: 'video', src: asset('portfolio/Vitalik/copy_6A1F0CDF-33CA-46A2-9273-C4AD5552033A.MP4'), alt: 'Creative Video' },
    ...
    { type: 'video', src: asset('portfolio/Vitalik/Instagram.MP4'), alt: 'Instagram Content' },
...
const CLIENT_HIGHLIGHT_LOGOS: { src: string; alt: string }[] = [
  { src: asset('portfolio/Companies%20i%20worked%20with/ChezMia_LogoLockup_ChezMiaBlue.png'), alt: 'Chez Mia Logo' },
  { src: asset('portfolio/Companies%20i%20worked%20with/ChezMia_Wordmark_Blue.png'), alt: 'Chez Mia Wordmark' },
];

const BEFORE_AFTER_PAIRS: { before: string; after: string }[] = [
  { before: asset('portfolio/Before_After/Chez%20Mia1%20(1).jpg'), after: asset('portfolio/Before_After/Chez%20Mia%20After.jpeg') },
  { before: asset('portfolio/Before_After/Brute%20Before.jpg'), after: asset('portfolio/Before_After/Brute%20After.jpeg') },
  { before: asset('portfolio/Before_After/BBN1.png'), after: asset('portfolio/Before_After/BBN2.png') },
];
